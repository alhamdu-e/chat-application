function Testomoni() {
	return (
		<div className="bg-slate-900 mx-5 sm:mx-14 md:mx-28 mb-32 px-7 py-14">
			<div className="flex items-center w-fit mx-auto mb-4 ">
				<img src="./images/p1.jpg" alt="" className="w-20 rounded-[100px]" />
				<div className="pl-6">
					<span className="text-slate-200  font-normale">ALhamdu Bedewe</span>
	...
	c-6.617,0-12,5.383-12,12C31,31.553,30.553,32,30,32z"
				...
				<p className="text-slate-300 font-thin italic -mt-6 xl:text-lg ">
					...
					ea dolorum. Autem aut quasi vero facilis porro, similique perferendis
					quas modi impedit soluta deserunt, minima minus aperiam dolores odit
					laudantium.
				</p>
			</div>
		</div>
