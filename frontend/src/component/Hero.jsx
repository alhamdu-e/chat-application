function Hero() {
	return (
		<div className="bg-customBlue  pt-10 text-center pr-5 pl-5 lg:pt-20">
			<div className="md:pt-5 sm:pr-14 sm:pl-14">
				...
				<div className="pt-5 sm:pr-14 sm:pl-14">
					<p className="text-gray-400  text-sm italic md:text-base ">
					...
					<button className="text-white btn-grad mt-6 px-5 py-2 md:px-7 md:py-2  w-fit">
